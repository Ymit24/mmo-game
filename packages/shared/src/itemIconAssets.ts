...
export const ITEM_ICON_ASSET_URLS: Record<string, string> = {
...
export function resolveItemIconAssetUrl(iconKey: string): string | null {
  return ITEM_ICON_ASSET_URLS[iconKey] ?? null;
}
